...
namespace Libralgo.Data.Context
{
    public class LibralgoDbContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Server=YAVUZ\\SQLEXPRESS;Database=LibralgoDb;Trusted_Connection=True;TrustServerCertificate=True");
        }
